...
import com.example.umbrellaappinkotlin.model.datasource.remote.retrofit.UrlConstants
...
class PresentWeather : AppCompatActivity(), Callback {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_present_weather)
        ...
        WeatherRepo.getWeather(this, zip, CurrentWeather.APPID)
        ForecastRepo.getForecast(this, zip, CurrentWeather.APPID)
    }
    ...
    override fun getWeatherResponse(weatherResponse: WeatherResponse) {
        ...
        val weatherIconUrl = UrlConstants.ICON_URL + icon + "@2x.png"
    ...
    override fun getForecastResponse(forecastResponse: ForecastResponse) {
        ...
        for (i in 0..39) {
            ...
            val weatherIconUrl = UrlConstants.ICON_URL + forecastResponse.list!!.get(i).weather!!.get(0).icon + "@2x.png"
